...
from GEMINI import load_gemini_pro_model, gemini_pro_response
from GEMINI import gemini_pro_vision_response, embeddings_model_response


working_dir = os.path.dirname(os.path.abspath(__file__))

#setting page configaration
...
if selected == "Image Captioning":
    ...
    if st.button("Generate Caption"):
        ...
        caption = gemini_pro_vision_response(default_prompt, image) #using gemini-1.5-flash LLM since gemini_pro_vision has depreviated
